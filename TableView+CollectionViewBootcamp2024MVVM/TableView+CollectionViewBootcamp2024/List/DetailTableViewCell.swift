...
class DetailTableViewCell: UITableViewCell {
    ...
    var detailTableViewModel = DetailTableViewCellModel()
    ...
    func setupCell(detail: Detail) {
        ...
        detailTableViewModel.setDetail(detail: detail)
    }
...
extension DetailTableViewCell: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return detailTableViewModel.numberOfItemsInSection
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell?.setupCell(item: detailTableViewModel.loadListItem(indexPath: indexPath))
        return cell ?? UICollectionViewCell()
    }
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return ContentCollectionViewCell.calculateSize(title: detailTableViewModel.getTitle(indexPath: indexPath))
    }
}
